        ...
        <table class="mt-1 table table-hover table-striped table-bordered ">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                          <a class="btn btn-primary"   href="edit_akun.php?no_reff=<?php echo $data['no_reff']; ?>">Edit</a>
                          <a class="btn btn-secondary" href="delete_akun.php?no_reff=<?php echo $data['no_reff']; ?>?>">Delete</a>
                    </td>
                </tr>
                <?php
                }
