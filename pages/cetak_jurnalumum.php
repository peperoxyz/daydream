...
<html lang="en">
  ...
  <body>
    <!-- NOTICE: You can use the _analytics.html partial to include production code specific code & trackers -->
      ...
      <a class="navbar-brand me-lg-5" href="../index.html"> <img class="navbar-brand-dark" src="../assets/img/brand/money.png" alt="Volt logo" /> <img class="navbar-brand-light" src="../assets/img/brand/dark.svg" alt="Volt logo" /> Cetak Jurnal Umum dengan Day-Dream!</a>
    ...
    <main class="content print-container">
        ...
        <div class="d-block mb-4 mb-md-0">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
              ...
              <li class="breadcrumb-item active" aria-current="page">Cetak Jurnal Umum</li>
            </ol>
          </nav>
          <h2 class="h4">Jurnal Umum</h2>
          <p>Jurnal Umum UMKM Anda.</p><br>
        </div>
            <?php
          ...
          <tbody>
            <?php
               ...
               $query       = "SELECT * FROM transaksi 
                              INNER JOIN akun on transaksi.no_akun = akun.no_reff AND transaksi.nama_akun = akun.no_reff WHERE transaksi.user_id = {$_SESSION['user_id']} ORDER BY tgl_transaksi ASC";
