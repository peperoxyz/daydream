    ...
    <main class="content">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-3">
        <div class="d-block mb-4 mb-md-0">
          ...
          <p class="mb-0">User dapat menginputkan transaksi UMKMnya pada halaman ini.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <form action="proses.php" autocomplete="off" method="POST" accept-charset="utf-8">
              ...
              <div class="row align-items-center mt-3">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input name="tanggal" data-datepicker="" class="form-control" id="tanggal" type="text" placeholder="dd/mm/yyyy" required />
                    </div>
                  </div>
                </div>
