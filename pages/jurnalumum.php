  ...
  <body>
    ...
    <main class="content">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-3">
        ...
        <div>
          <a class="btn btn-gray-800 mt-2 animate-up-2 primary mb-4" target="_blank" href="cetak_jurnalumum.php" type="submit">Cetak Jurnal Umum</a>
        </div>
        ...
        <table class="table">
          ...
          <tbody>
            <?php
             ...
             ?>
            <tr>
              <td ><b><?php echo $tmp_date != $data['tgl_transaksi'] ? $data['tgl_transaksi'] : "";?></b></td>
              ...
              <td>
                  ...
                  <a class="btn btn-secondary" href="delete_jurnal.php?id=<?php echo $data['id']; ?>?>">Delete</a>                
              </td>
            </tr>
